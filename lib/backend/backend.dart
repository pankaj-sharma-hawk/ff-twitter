...
import 'schema/relations_record.dart';
...
export 'schema/relations_record.dart';
...
/// Functions to query RelationsRecords (as a Stream and as a Future).
Stream<List<RelationsRecord>> queryRelationsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RelationsRecord.collection,
...
Future<List<RelationsRecord>> queryRelationsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<RelationsRecord>> queryRelationsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
