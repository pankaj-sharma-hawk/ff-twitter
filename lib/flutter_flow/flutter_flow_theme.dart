...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0x40FFFFFF);
  late Color primaryBackground = const Color(0xFF000000);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);

  late Color cardBackGround = Color(0xFF000000);
  late Color lineColor = Color(0xFF8BC34A);
  late Color backgroundComponents = Color(0xFF8BC34A);
  late Color btnText = Color(0xFFFFFFFF);
  late Color iconColor = Color(0xFFFFFFFF);
  late Color customColor4 = Color(0xFF090F13);
  late Color background = Color(0xFF2B08F6);
  late Color customColor1 = Color(0xFF8BC34A);
}
